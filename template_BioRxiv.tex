...
\lhead{{\footnotesize Author et al.}}
\chead{}
\rhead{{\footnotesize Running head here}}
\lfoot{\ccbynd}
\cfoot{\thepage}
\rfoot{\biorxiv}
...
\lhead{\biorxiv}
\chead{}
\rhead{{\footnotesize DOI here if wanted}}
\lfoot{}
\cfoot{\ccbynd}
\rfoot{}
}
...
Blah blah \cite[see ][ for details]{Vargasetal_2012_PLoSONE}blah.
%\subsection{Use subsections if wanted}

\section{Results}
Blah blah blah \cite[e.g. ][]{BreedyandGuzman_2003a_Zootaxa}.
%\subsection{Use subsections if wanted}

\section{Discussion}

Blah blah blah. \cite{AmentVelasquezetal_2016_MPE}
%\subsection{Use subsections if wanted}
